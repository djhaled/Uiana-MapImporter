...
// End Cross Module References
	...
	DEFINE_FUNCTION(AValActor::execCreateStaticComponent)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->CreateStaticComponent(Z_Param_Out_NewComp);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(AValActor::execCreateInstanceComponent)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->CreateInstanceComponent(Z_Param_Out_NewComp);
		P_NATIVE_END;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AValActor_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AValActor_CreateInstanceComponent, "CreateInstanceComponent" }, // 645676986
		{ &Z_Construct_UFunction_AValActor_CreateStaticComponent, "CreateStaticComponent" }, // 1879404429
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RangeRemake_Plugins_Uiana_Source_Uiana_Public_ValActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AValActor, AValActor::StaticClass, TEXT("AValActor"), &Z_Registration_Info_UClass_AValActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AValActor), 93265198U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RangeRemake_Plugins_Uiana_Source_Uiana_Public_ValActor_h_338244254(TEXT("/Script/Uiana"),
